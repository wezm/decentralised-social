...
- Improved rich media embeds with OEmbed.
- `[:rich_media, :oembed_providers_enabled]` configuration option to enable/disable the list of OEmbed providers for rich media embeds.
